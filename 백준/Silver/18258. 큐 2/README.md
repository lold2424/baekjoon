...
해당 문제에서는 FIFO 방식이 아니기 때문에 Duque(덱)을 이용하였다.

시간제한이 촉박해서 ArrayList를 사용하면 오류가 발생하기 때문에 LinkedList로 풀었다.

문제를 다 풀고 다른사람들의 문제풀이를 보니, 직접 구현하는 방식도 있는걸 보고 추가로 풀어보았다.
